...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
    private Claims setSigningKey(HttpServletRequest request) {
        ...
        return Jwts.parserBuilder()  // Use parserBuilder for the newer library versions
                .setSigningKey(getSigningKey(KEY))  // Replace verifyWith with setSigningKey
                .build()
                .parseClaimsJws(jwtToken)
                .getBody();  // Retrieve the claims directly
    }
